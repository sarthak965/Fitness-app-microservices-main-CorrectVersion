      ...
      <section className="section-shell">
        <div className="grid gap-6 xl:grid-cols-[0.72fr_1.28fr]">
          ...
          <div className="grid gap-4 md:grid-cols-[1.2fr_0.8fr]">
            <div className="rounded-[28px] border border-slate-200 bg-gradient-to-br from-white via-white to-cyan-50/50 p-6">
              <div className="text-sm font-semibold text-slate-500">Selected activity</div>
              ...
              <div className="mt-4 flex flex-wrap gap-2 text-sm text-slate-600">
                {activityType ? <span className="rounded-full bg-slate-100 px-3 py-1">{titleCase(activityType)}</span> : null}
                {duration ? <span className="rounded-full bg-slate-100 px-3 py-1">{duration} min</span> : null}
                {activityId ? <span className="rounded-full bg-emerald-50 px-3 py-1 text-emerald-700">Context attached</span> : null}
              </div>
            </div>

            <div className="rounded-[28px] border border-slate-200 bg-gradient-to-br from-white via-white to-amber-50/60 p-4">
              <div className="text-sm font-semibold text-slate-500">Quick prompts</div>
              <div className="mt-4 grid gap-3">
                {starterPrompts.map((prompt) => (
                  <button
                    key={prompt}
                    className="rounded-[22px] border border-slate-200 bg-slate-50 px-4 py-4 text-left text-sm text-slate-700 transition hover:border-slate-300 hover:bg-white"
